...
(function( $ ) {
    $.widget("metro.calendar", {
        ...
        _renderMonth: function(){
            ...
            $("<td/>").addClass("text-center").html("<a class='btn-previous-year minhacordefundo' href='#'><i class='icon-previous '></i></a>").appendTo(tr);
            $("<td/>").addClass("text-center").html("<a class='btn-previous-month minhacordefundo' href='#'><i class='icon-arrow-left-4'></i></a>").appendTo(tr);
            $("<td/>").attr("colspan", 3).addClass("text-center").html("<a class='btn-select-month minhacordefundo' href='#'>" + this.options.months[month] + ' ' + year + "</a>").appendTo(tr);
            $("<td/>").addClass("text-center").html("<a class='btn-next-month minhacordefundo' href='#'><i class='icon-arrow-right-4'></i></a>").appendTo(tr);
            $("<td/>").addClass("text-center").html("<a class='btn-next-year minhacordefundo' href='#'><i class='icon-next'></i></a>").appendTo(tr);
